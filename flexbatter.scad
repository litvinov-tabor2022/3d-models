            ...
            union() {
                ...
                for (sy = [- 1, 1])scale([1, sy, 1]) {
                    ...
                    translate([ch, d / 2 + w - ws / 2, 0])rotate(- 90)
                        ...
                        sline([0, 180, 0, 180, 0, - 180, 0, 90, 0], [r + ch + el, D / 4, el, D / 12, el / 2, D / 12, 1 + el / 2, D / 5, D /
                            3], 0, ws, hf * d + w);
            ...
            if (deepen > 0)
                translate([w + l / 2 - 0.5, - d / 2 - w - 0.01, w + d + l])
                    rotate([- 90, 0, 0]) {
                        ...
                        if (i == n - 1)translate([0, 0, d + 2 * w - ch])cylinder(r2 = l + deepen * d + ch, r1 = l + deepen * d, h = ch +
                            0.02, $fn = 72);
